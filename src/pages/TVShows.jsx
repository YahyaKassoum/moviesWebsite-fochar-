...
const TVShows = () => {
  ...
  // Fetch popular TV shows using the custom hook
  const { data: tvShows, loading, error } = useFetchMovies("trending/tv/day?language=en-US", currentPage);

  // Update total pages when data is fetched
  useEffect(() => {
    // Limit to 10 pages as per your requirement
    setTotalPages(Math.min(10, tvShows.total_pages || 10));
  }, [tvShows]);
    ...
    return (
      <div className="min-h-screen bg-gray-900 flex items-center justify-center">
        <div className="text-center text-white">
          ...
          <p className="text-xl">Loading TV Shows...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-gray-900 flex items-center justify-center text-center">
        <div className="text-white">
          <p className="text-2xl font-bold mb-4">No TV Shows Found</p>
  ...
  return (
    <div className="min-h-screen bg-gray-900 p-6">
      <div className="container mx-auto">
        <h1 className="text-3xl font-bold text-white mb-8 text-center">Popular TV Shows</h1>
